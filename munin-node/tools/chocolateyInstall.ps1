...
$packageName = 'munin-node' # arbitrary name for the package, used in messages
$installerType = 'exe' #only one of these two: exe or msi
$url = 'https://munin-node-win32.googlecode.com/files/munin-node-win32-1.6.1.0-installer-beta.exe' # download url
